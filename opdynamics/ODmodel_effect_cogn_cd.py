...
nrparamchange = 30
distcds = np.linspace(0,0.2,nrparamchange)
...
# np.save('out_distcd_0_2_nrparams_30_2_OPs_stabil200',OPs)
# np.save('out_distcd_0_2_nrparams_30_2_categories_stabil200',categories)
# np.save('out_distcd_0_2_nrparams_30_dist_opinions_stabil200',dist_opinions)
# np.save('out_distcd_0_2_nrparams_30_distcds_stabil200',distcds)
