...
# Create network for visualization
    ...
    plt.title(figtitle)
    if savef:
        plt.savefig('fig_Ts/' + simstr + figtitle + '.png')
...
nrparamchange=30
Ts = np.linspace(0.01,1.5,nrparamchange)
...
# np.save('out_T_01_15_nrparams_30_OPs_stabil200',OPs)
# np.save('out_T_01_15_nrparams_30_categories_stabil200',categories)
# np.save('out_T_01_15_nrparams_30_dist_opinions_stabil200',dist_opinions)
# np.save('out_T_01_15_nrparams_30_Ts_stabil200',Ts)
